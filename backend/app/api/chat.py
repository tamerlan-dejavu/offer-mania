...
async def chat_stream(
    ...
    async def generate():
        ...
        for chunk in llm.stream_response(request.user_message, history_for_gemini, system_prompt):
        ...
        async with async_session() as save_session:
            ...
            await save_repo.save_message(session_id, MessageRole.ASSISTANT, full_text)
